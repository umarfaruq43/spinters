        ...
        <Box>
            ...
            >
                <Wapper title={"1. Acceptance of Terms"}>
                    <Text>
                        By accessing or using the Sprinters Technologies website
                        (the {"Website"}), you agree to comply with and be bound
                        by these Terms of Use. If you do not agree to these
                ...
                <Wapper title="2. Use of the Website">
                    ...
                    with and be bound by theseTerms of Use. You agree to use the
                    website only for lawful purposes and in a manner consistent
                    with all applicable laws and regulations. Sprinters
                    Technologies reserves the right to refuse service, or
                    restrict access at its discretion. If you do not agree with
                    any part of these terms, you may not use the website. You
                    are prohibited from engaging in any activities that violate
                    laws, infringe on the rights of others, or disrupt the
                    functionality of the website. To access this website, you do
                    not need to create a user account. Users must be at least 13
                    years old to access our website and use our services. By
                    using the website, you affirm that you meet this eligibility
                    requirement.
                </Wapper>
                ...
                <Wapper title={"3. Intellectual Property"}>
                    <Box>
                        ...
                        <Text>
                            ...
                            software, is the property of Sprinters Technologies
                    ...
                    <Box mt="1rem">
                        ...
                        <Text>
                            ...
                            and non-commercial purposes. Any unauthorized use
                ...
                <Wapper title={"4. User Content"}>
                    <Box>
                        ...
                        <Text>
                            ...
                            the website. However, by posting content, you grant
                            Sprinters Technologies a worldwide, irrevocable,
                    ...
                    <Box mt="1rem">
                        ...
                        <Text>
                            ...
                            rights or applicable laws. Sprinters Technologies
                ...
                <Wapper title={"5. Privacy"}>
                    <Box>
                        <Text>
                            ...
                            outlines how we collect, use, disclose and protect
                            your personal information. By using the website, you
                            agree to the terms outlined and practices described
                ...
                <Wapper title={"6. Disclaimer of Warranties"}>
                    <Box>
                        ...
                        <Text mt="1rem">
                            ...
                            damages arising from your use or inability to use
                            the website. This includes direct, indirect,
                ...
                <Wapper title={"8. Termination"}>
                    <Text>
                        Sprinters Technologies reserves the right to terminate
                        or suspend your access to the website without prior
                        notice for any reason, including but not limited to a
                        breach of these Terms of Use. You may also terminate
                        your access at any time as you so wish. Upon
                ...
                <Wapper title={"10. Changes to Terms"}>
                    <Text>
                        Sprinters Technologies reserves the right to update or
                        modify these Terms of Use at any time. Continued use of
                        the Website after such changes constitutes acceptance of
                        the modified terms.
                    </Text>
                </Wapper>
                <Wapper title={"11. Contact Information"}>
                    <Text>
                        ...
                        Terms of Use, you may contact Sprinters Technologies at
                        the following:
                ...
                <Wapper title={"12. Effective Date"}>
                    <Text>
                        This Website term of use is effective from the 30th Day
                        of November, 2023.
                    </Text>
                </Wapper>
            </Stack>
