...
// "https://sprinters-technologies-e6f018af828d.herokuapp.com/v1";
export const endpointUrl = "https://sprinters-trick.onrender.com/V1";
export const bearerToken = Cookies.get("sprinters_token");
...
export const testimonyData = [
...

    {
        ...
        ans: `You can reach out to us through our <a href="/contact" style="color:#44B649" >Contact Page</a> or email at <a href="mailto:info@sprinterstechnologies.com" style="color:#44B649" target="_blank" > info@sprinterstechnologies.com </a> Our team is ready to assist you with any questions or requirements.`,
    },
    {
    ...
    },
    {
        ...
        ans: `To request a quote, please visit our <a href="/contact#form" style="color:#44B649" >Get in touch page</a>  and fill out the provided form. We will promptly review your requirements and get in touch with you.`,
    },
];
...
export const ServiceDetailData = [
    {
        ...
        des: "Sprinters Technologies Tech Consultancy division is your strategic partner in navigating the digital landscape, offering expert guidance. We specialize in crafting clear paths to success through comprehensive Technology Roadmaps, aligning with your business objectives.",
    ...
    },
    {
        ...
        des: "Sprinters Technologies specializes in creating visually appealing and highly functional websites that align with your brand identity and business objectives. Our expertise extends to responsive web development, ensuring optimal performance across desktops, tablets, and mobile phones.",
    ...
    },
    {
        ...
        normalTitle: "Mobile",
        editableTitle: "development",
        des: "Sprinters Technologies excels in iOS and Android app development, crafting custom mobile applications tailored to meet your unique business needs and user expectations. Our expertise extends to cross-platform development, ensuring your app reaches a broader audience.",
    ...
    },
    {
        ...
        des: "Sprinters Technologies provides comprehensive solutions to elevate your business processes. Our expertise includes Business Process Automation to streamline operations, reduce manual tasks, and improve efficiency.",
...
export const teamData = [
    ...
    {
        name: "Mashood Khadijat",
        img: "/t_7.png",
        role: "Data Analyst",
    },
    {
        name: "Megida Ayatudeen",
        img: "/t_8.png",
